...
use Meup\Api\Client\HttpClient\Listener\ErrorListener;
...
class ErrorListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @expectedException \Meup\Api\Client\Exception\RuntimeException
     */
    ...
    /**
     * @test
     * @expectedException \Meup\Api\Client\Exception\ErrorException
     */
     ...
     * @expectedException \Meup\Api\Client\Exception\ValidationFailedException
     */
