...
use Meup\Api\Client\ResultPager;
...
class ResultPagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function shouldGetAllResults()
    {
        ...
        // memberApi Mock
        $orderApiMock = $this->getApiMock('Meup\Api\Client\Api\Order');
        $orderApiMock
            ->expects($this->at(0))
            ->method('all')
    ...
    public function shouldGetSomeResults()
    {
        ...
        $result    = $paginator->fetch($orderApiMock, 'all', array('Meup\Api\Client'));
    ...
    protected function getHttpClientMock($responseMock = null)
    {
        ...
        $httpClientMock =
            $this->getMock('Meup\Api\Client\HttpClient\HttpClient', array(), array(array(), $clientInterfaceMock));
